...
/**
 * `defaultRiskPct` ayarlardan (User.maxRiskPerTrade) geliyor.
 *
 * Risk yuzdesi burada "1" olarak sabitti ve ayarlardaki "max risk per trade"
 * alani Supabase metadata'sina yaziliyordu — yani kullanicinin kaydettigi
 * deger hicbir yerde kullanilmiyordu. Ayar artik gercekten bir sey yapiyor.
 */
export function RiskCalculator({ defaultRiskPct }: { defaultRiskPct: number }) {
